...
user = {
    ...
    terminal = "kitty --config ~/.config/awesome/config/kitty.conf",
    floating_terminal = "kitty --config ~/.config/awesome/config/kitty.conf",
    browser = "firefox",
    file_manager = "kitty --class files -e ranger --config ~/.config/awesome/config/kitty.conf",
    editor = "kitty --class editor -e vim --config ~/.config/awesome/config/kitty.conf",
    email_client = "kitty --class email -e neomutt --config ~/.config/awesome/config/kitty.conf",
    music_client = "kitty -o font_size=12 --class music -e ncmpcpp --config ~/.config/awesome/config/kitty.conf",
