...
local tag_colors_empty = { "#00000000", "#00000000", "#00000000", "#00000000", "#00000000", "#00000000", "#00000000",
    "#00000000", "#00000000", "#00000000" }

local tag_colors_urgent = { x.foreground, x.foreground, x.foreground, x.foreground, x.foreground, x.foreground,
    x.foreground, x.foreground, x.foreground, x.foreground }
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the tray box
    s.traybox = wibox({ screen = s, width = dpi(150), height = beautiful.wibar_height, bg = "#00000000", visible = false,
        ontop = true })
    s.traybox:setup {
        {
            {
...
function wibars_toggle()
    ...
    s.dock.visible = false -- not s.dock.visible
end

function tray_toggle()
    local s = awful.screen.focused()
    s.traybox.visible = false -- Rnot s.traybox.visible
end
