...
keys.globalkeys = gears.table.join(
    awful.key({ altkey }, "space",
        function()
            awful.spawn.with_shell("~/.config/awesome/config/rofi/bin/launcher_colorful")
        end,
        { description = "toggle rofi", group = "client" }),
    -- Focus client by direction (hjkl keys)
    awful.key({ superkey }, "space",
        function()
            awful.spawn.with_shell("~/.config/awesome/config/scripts/toggle_eww")
        end,
        { description = "toggle eww", group = "client" }),
    ...
    awful.key({ superkey }, "Return",
        function() awful.spawn.with_shell(user.terminal) end,
        { description = "open a terminal", group = "launcher" }),
    -- Spawn floating terminal
    awful.key({ superkey, shiftkey }, "Return", function()
        awful.spawn.with_shell(user.floating_terminal, { floating = true })
    end,
    ...
    awful.key({ shiftkey }, "Print", function() apps.screenshot("clipboard") end,
...
-- Move to edge or swap by direction
    ...
    awful.key({ superkey, ctrlkey }, "c", function(c)
