...
user = {
    ...
    terminal = "kitty --single-instance --config ~/.config/awesome/config/kitty/kitty.conf",
    floating_terminal = "kitty --single-instance --config ~/.config/awesome/config/kitty/kitty.conf",
    browser = "firefox",
    file_manager = "kitty --single-instance --class files -e ranger --config ~/.config/awesome/config/kitty/kitty.conf",
    editor = "kitty --single-instance --class editor -e nvim --config ~/.config/awesome/config/kitty/kitty.conf",
    email_client = "kitty --single-instance --class email -e neomutt --config ~/.config/awesome/config/kitty/kitty.conf",
    music_client = "kitty --single-instance -o font_size=12 --class music -e ncmpcpp --config ~/.config/awesome/config/kitty/kitty.conf",
    ...
    openweathermap_key = "1763781397e30ff43348fe6dd0fc3ab8",
    openweathermap_city_id = "1264527",
